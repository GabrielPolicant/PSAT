...
<body>
    ...
    <form id="infoForm" action="processamento.php" method="post">
        <!-- Header -->
            ...
            foreach ($listarFinal as $perguntaFinal) { ?>
                <div class="questao1">
                    ...
                    if ($perguntaFinal['TIPO'] == 'CHECK') { ?>
                        ...
                        <h3><?php echo $perguntaFinal['CODIGO']; ?>) <?php echo $perguntaFinal['NOME']; ?></h3>
                        <label class="label-main-coment">
                            <textarea id="coment" name="<?php echo $perguntaFinal['ID']; ?>" rows="2" maxlength="200" placeholder="Digite seus comentários aqui..."  ></textarea>
                        </label>
                    <?php }
